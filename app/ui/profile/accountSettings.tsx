  ...
  return (
    <main className="flex justify-center flex-col items-center min-h-full md:mx-32">
      ...
      <div className="flex flex-col justify-center mt-5 w-full">
        ...
        >
          <h2 className="text-base md:text-xl md:font-semibold">First Name</h2>
          <input
        ...
        <div
          ...
          md:mt-10 md:ml-20 md:flex-col"
        >
          <h2 className="text-base md:text-xl md:font-semibold">Last Name</h2>
          <input
            className="border-b-2 border-gray-300 w-1/2 
            md:outline md:rounded md:border-black md:border-0 md:p-3 md:mt-2"
        ...
        <div
          ...
          md:mt-10 md:ml-20 md:flex-col"
        >
          <h2 className="text-base md:text-xl md:font-semibold">Email</h2>
          <input
            className="border-b-2 border-gray-300 w-1/2 
            md:outline md:rounded md:border-black md:border-0 md:p-3 md:mt-2"
      ...
      <div className="flex-grow flex flex-col justify-end items-center">
        <button
          className="border bg-custom-logout text-black w-auto px-40 py-2 font-bold rounded-xl text-lg mt-96"
