  ...
  return (
    <main className="flex justify-center flex-col items-center min-h-full md:mx-32">
      <div className="flex flex-row items-center justify-center mt-10 w-full">
        ...
        />
        <h1
          className="text-xl font-bold mx-auto w-full text-center 
      ...
      <div className="flex-grow flex flex-col justify-end items-center">
        <button className="border bg-custom-logout text-black w-auto px-40 py-2 font-bold rounded-xl text-lg mt-96">
          Sign Out
        </button>
        {/* fix the button */}
      </div>
